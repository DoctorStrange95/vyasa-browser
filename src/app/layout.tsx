...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "infant mortality rate India state wise", "NFHS-6 data India", "NFHS-5 vs NFHS-6", "IDSP outbreak report India",
    "vaccination coverage India state wise", "child stunting wasting underweight India",
    "total fertility rate India", "institutional births India", "anaemia India women",
    "diabetes hypertension obesity India NFHS", "hospital infrastructure India district",
    "India disease surveillance IDSP", "MoHFW data portal", "SRS 2023 India state",
    "Ayushman Bharat hospital list", "PMJAY hospitals India", "state health ranking India", "public health dashboard India",
    ...
    "Vyasa Integrated Healthcare", "Vyasa Health OS", "Vyasa health platform",
  ],
  authors: [{ name: "Vyasa Integrated Healthcare", url: BASE_URL }],
  creator: "Vyasa Integrated Healthcare",
  publisher: "Vyasa Integrated Healthcare",
  openGraph: {
    type: "website",
    locale: "en_IN",
    url: BASE_URL,
        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            "publisher": {
              ...
              "sameAs": ["https://app.vyasaa.com", "https://health.vyasaa.com", "https://www.vyasaa.com"],
            },
          }) }}
        />
        {/* PWA */}
